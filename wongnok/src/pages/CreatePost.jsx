import { Button, FileInput, Select, TextInput, Alert,Label } from 'flowbite-react'
    ...
    <div className='[p-3 max-w-3xl mx-auto min-h-screen'>
        ...
        <form action='flex flex-col gap-4' onSubmit={handleSubmit}>
            <div className='flex flex-col gap-4 sm:flex-row justify-between'>
                <TextInput type='text' placeholder='Title : ชื่อเมนู' required id='title' className='flex-1' onChange={(e) => setFormData({ ...formData, title: e.target.value })}></TextInput>
