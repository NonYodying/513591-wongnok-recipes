...
export default function DashProfile() {
    ...
    const [imageFileUploading, setImmageFileUploading] = useState(false);
    ...
    <div className="max-w-lg mx-auto p-3 w-full" >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4" >
            ...
            >
                ...
                alt='user' className="rounded-full w-full h-full border-8 border-[lightgray] ">
                </img>
            </div>
        ...
        <div className="text-red-500 flex justify-between nmt-5">
